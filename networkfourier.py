    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'valid']:
            ...
            for data in dataloaders[phase]:
                ...
                fourier0 = torch.rfft(inputs[:,0],1,onesided=False)
                fourier1 = torch.rfft(inputs[:,1],1,onesided=False)
                fourier2 = torch.rfft(inputs[:,2],1,onesided=False)
...
model_trained = train_model(model, criterion, optimizer, exp_lr_scheduler,
                       num_epochs=8)
torch.save(model_trained.state_dict(), 'models/modelfourier.pth')